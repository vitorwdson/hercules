...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('CONFIRMED', 'IN_PROGRESS', 'FIXED', 'WONTFIX', 'DUPLICATE');
...
-- AddForeignKey
ALTER TABLE "IssueStatus" ADD CONSTRAINT "IssueStatus_issueId_fkey" FOREIGN KEY ("issueId") REFERENCES "Issue"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
